function [H_cA2cB,X_cA2cB,Sigma_X_cA2cB] = mean_H_c12c2(H_g2c1, H_g2c2, tfPlot)
%MEAN_H_C12C2 - Yields average transform between two rigidly mounted
%cameras along with the standard deviation and covariance of the data
%
%   This function has been renamed extrinsicTranslationStats
%
%   [H_cA2cB,X_cA2cB,Sigma_X_cA2cB] = mean_H_c12c2(H_g2c1, H_g2c2) takes two datasets 
...
%
%   [H_cA2cB,X_cA2cB,Sigma_X_cA2cB] = mean_H_c12c2(__,__,tfPlot)
%
