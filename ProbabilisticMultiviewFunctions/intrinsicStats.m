function [A_c2m_mean, v_A_c2m_cov, bad] = intrinsicStats(A_c2m,A_c2m_mean)
%INTRINSICSTATS takes a cell array of intrinsic matrices and returns a
%single mean matrix and associated covariance after removing outliers
%
%   [A_c2m_mean, v_A_c2m_cov, bad] = meanIntrinsics(A_c2m) calculates a
