...
for i=1:numel(H_c12c2_ex)
    h{i} = triad('Parent',axs,'Scale',2,'LineWidth',1,'Matrix', H_c12c2_ex{i}, 'linestyle', ':');
end


h_cal = triad('Parent',axs,'Scale',5,'LineWidth',2,'Matrix', H_c12c2_mean, 'axislabels', {"", "calibration", ""});
h_truth = triad('Parent',axs,'Scale',5,'LineWidth',2,'Matrix', H_c12c2_MoCap, 'axislabels', {"", "MoCap", ""});
h_mu = triad('Parent',axs,'Scale',5,'LineWidth',2,'Matrix', H_c12c2_mu, 'axislabels', {"", "mean", ""});
